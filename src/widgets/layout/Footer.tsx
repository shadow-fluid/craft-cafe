...
import SectionNav, { INavItem } from '@entity/layout/footer/SectionNav';
import ExploreSection, { IItemExplore } from '@entity/layout/footer/ExploreSection';
import ContactInfo from '@entity/layout/footer/ContactInfo';
import SocialLinks, { IItemSocial } from '@entity/layout/footer/SocialLinks';
import SubscriptionForm from '@entity/layout/footer/SubscriptionForm';
import Established from '@entity/layout/footer/Established';
